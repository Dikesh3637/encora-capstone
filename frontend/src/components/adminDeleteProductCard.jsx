...
import deleteProduct from "../query/deleteProductQuery";
import { toast } from "sonner";
import { useQueryClient } from "@tanstack/react-query";

const AdminDeleteProductCard = ({ product, onSelect }) => {
    ...
    >
      ...
      <div className="card-body p-5">
        ...
        <div className="card-actions w-full flex justify-end mt-4 gap-2">
          <button className="btn btn-warning" onClick={onDeleteHandler}>
            Delete
          </button>
        </div>
      </div>
